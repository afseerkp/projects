(function($) {
    ...
    $('a.add_to_cart_button').addClass('ti-shopping-cart');
    $('.woocommerce .thumbnails .owl-nav .owl-prev i').addClass('ti-arrow-left');
    $('.woocommerce .woocommerce-product-search button').addClass('ti-search');
     $('.outofstock a.ajax_add_to_cart, .outofstock a.add_to_cart, a.added_to_cart.wc-forward, a.product_type_variable.add_to_cart_button, a.product_type_external, a.view-wishlist, a.yith-wcqv-button, a.add_to_cart_button, .woocommerce-product-search button').text('');
